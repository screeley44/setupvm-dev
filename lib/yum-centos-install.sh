...
then  
  ...
  yum install -y wget gcc python-virtualenv git net-tools unzip bash-completion telnet kexec-tools sos psacct NetworkManager jq yum-utils device-mapper-persistent-data lvm2 >/dev/null 2>&1
